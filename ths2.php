...
<head>
  ...
  <title>Ευχαριστώ! Η παραγγελία σας έγινε αποδεκτή.</title>
...
<main>
  ...
  <div class="ty-heading">
    ...
    <p class="ty-heading__title">Ευχαριστώ!</p>
    <p class="ty-heading__subtitle">Η παραγγελία σας έγινε αποδεκτή</p>
    <p class="ty-heading__text">Ένας εκπρόσωπος θα επικοινωνήσει μαζί σας σύντομα για να επιβεβαιώσει την παραγγελία σας</p>
  </div>
    ...
    <div class="ty-content__col">
      <div id="entered_data" class="ty-form --entered-data">
        <div class="ty-col__box">
          <p class="ty-content__title">Ελέγξτε αν οι πληροφορίες που εισάγατε είναι σωστές:</p>

          <div class="ty-form__row">
            <label for="name" class="ty-form__label">
              <span class="ty-label__text">Όνομα </span>
              <span class="ty-form__input"><?php echo ($data["name"])?></span>
            </label>

            <label for="phone" class="ty-form__label">
              <span class="ty-label__text">Τηλέφωνο </span>
              <span class="ty-form__input"><?php echo ($data["phone"])?></span>
            </label>

            <button type="button" class="ty-form__edit" id="ty_form_edit">Επεξεργασία δεδομένων</button>
          </div>
      ...
      <form id="form" class="ty-form --form-hidden" geo="gr" action="api.php" method="post"
	onsubmit="return validate_form(this, 'Πληκτρολογηστε τον σωστο αριθμο τηλεφωνου');">
        ...
        <div class="ty-col__box">
          ...
          <div class="ty-form__row">
            ...
            <button type="submit" class="ty-form__submit">Αποθήκευση δεδομένων</button>
